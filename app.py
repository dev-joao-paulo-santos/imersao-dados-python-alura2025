...
st.title(":bar_chart: Dashboard de Salários na Área de Dados")
...
with col_graf2:
    if not df_filtrado.empty:
        grafico_hist = px.histogram(
            ...
            labels={'usd': 'Salário Anual', 'count': 'Quantidade'}
        )
        grafico_hist.update_layout(title_x=0.1)
        st.plotly_chart(grafico_hist, use_container_width=True)
    else:
        st.warning("Nenhum dado para exibir no gráfico de distribuição salarial")
